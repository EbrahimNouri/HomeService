...
public class AdminControllerImpl {
    ...
    public void addAdmin(@RequestBody @Valid Person admin) {
    ...
    @GetMapping() //checked
    public PersonFindDto admin(Authentication authentication) {
        Person admin = (Person) authentication.getPrincipal();
        return PersonFindDto.adminTopPersonFindDtoMapper(admin);
    }
    ...
    public ExpertTypeServiceMapped findExpertTypeServiceById(@PathVariable Long expertId
        ...
        return ExpertTypeServiceMapped.getExpertTypeServiceMapped(expert, typeService);
    }
